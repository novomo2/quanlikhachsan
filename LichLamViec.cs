namespace QLKSHOANGLONG.Model
{
    ...
    public partial class LichLamViec
    {
        ...
        public static LichLamViec GetLichLamViec(int IdlichLamViec)
        {
            QLKSModel context = new QLKSModel();
            return context.LichLamViecs.Where(p => p.IDLichLamViec == IdlichLamViec).FirstOrDefault();
        }
        ...
        {
            QLKSModel context = new QLKSModel();
            LichLamViec db = context.LichLamViecs.Where(p => p.IDLichLamViec == id).FirstOrDefault();
            if (db != null)
            {
