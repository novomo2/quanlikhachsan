namespace QLKSHOANGLONG.Model
{
    ...
    public partial class VatTu
    {
        ...
        public static VatTu GetVatTu(int IdvatTu)
        {
            QLKSModel context = new QLKSModel();
            return context.VatTus.Where(p => p.IDVatTu == IdvatTu).FirstOrDefault();
        ...
        {
            QLKSModel context = new QLKSModel();
            VatTu db = context.VatTus.Where(p => p.IDVatTu == id).FirstOrDefault();
            if (db != null)
            {
